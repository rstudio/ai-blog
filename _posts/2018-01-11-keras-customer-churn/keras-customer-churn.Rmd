...
description: |
  Using Keras to predict customer churn based on the IBM Watson Telco Customer 
  Churn dataset. We also demonstrate using the lime package to help explain
...
date: 01-11-2018
preview: images/shiny-application.png
