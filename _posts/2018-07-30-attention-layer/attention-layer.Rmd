...
There are many ways to go from here. For one, we didn't do any hyperparameter optimization.^[See e.g. [@LuongPM15] for an extensive experiment on architectures and hyperparameters for NMT.]
