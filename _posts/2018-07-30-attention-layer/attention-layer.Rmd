...
[1] "Predicted translation: <start> Ik . <stop>"
[1] "Input: <start> Look in the mirror . <stop>"
[1] "Predicted translation: <start> Ik . <stop>"
[1] "Input: <start> Tom wanted revenge . <stop>"
[1] "Predicted translation: <start> Ik . <stop>"
[1] "Input: <start> It s very kind of you . <stop>"
[1] "Predicted translation: <start> Ik . <stop>"
[1] "Input: <start> I refuse to answer . <stop>"
[1] "Predicted translation: <start> Ik . <stop>"
```
...
```
[1] "Input: <start> I did that easily . <stop>"
[1] "Predicted translation: <start> Ik ben een een een een een een een een een een"
[1] "Input: <start> Look in the mirror . <stop>"
[1] "Predicted translation: <start> Tom is een een een een een een een een een een"
[1] "Input: <start> Tom wanted revenge . <stop>"
[1] "Predicted translation: <start> Tom is een een een een een een een een een een"
[1] "Input: <start> It s very kind of you . <stop>"
[1] "Predicted translation: <start> Ik ben een een een een een een een een een een"
...
```
[1] "Input: <start> I did that easily . <stop>"
[1] "Predicted translation: <start> Ik heb je niet . <stop>"
[1] "Input: <start> Look in the mirror . <stop>"
[1] "Predicted translation: <start> Ga naar de buurt . <stop>"
[1] "Input: <start> Tom wanted revenge . <stop>"
[1] "Predicted translation: <start> Tom heeft Tom . <stop>"
[1] "Input: <start> It s very kind of you . <stop>"
[1] "Predicted translation: <start> Het is een auto . <stop>"
[1] "Input: <start> I refuse to answer . <stop>"
[1] "Predicted translation: <start> Ik heb de buurt . <stop>"
```
