---
title: "An attention mechanism for Keras"
description: |
...
Last not least, no one said attention need be useful only in the context of machine translation. Out there, a plenty of sequence prediction (time series) problems are waiting to be explored for its potential usefulness...
