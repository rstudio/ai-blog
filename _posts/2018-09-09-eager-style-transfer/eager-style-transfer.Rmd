...
preview: images/style_epoch_1000.png
---
...
Style transfer on images is not new, but got a boost when [@GatysEB15a] showed how to successfully do it with deep learning.
...
As usual, please make sure you have the required package versions installed. And no need to copy the snippets - you'll find the complete code among the [Keras examples](https://github.com/rstudio/keras/tree/master/vignettes/examples/eager-styletransfer.R).
...
knitr::include_graphics("images/isar.jpg")
```
...
```{r, layout="l-body", eval=TRUE, echo=FALSE}
knitr::include_graphics("images/The_Great_Wave_off_Kanagawa.jpg")
```
