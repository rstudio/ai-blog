---
title: "Image-to-image translation with pix2pix: An implementation using Keras and eager execution"
description: |
...
As computer programs work with numbers, the cost function has to be pretty specific: We can't just say _predict next month's demand for lawn mowers please, and do your best_, we have to say something like this: Minimize the squared deviation of your estimate from the target value. 
