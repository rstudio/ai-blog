...
description: >
 Generative adversarial networks, neural style transfer, the famous attention mechanism ubiquitous not just in natural language processing only - applications like these used to be not-so-simple to code in the usual Keras declarative coding paradigm. Now, with the event of TensorFlow eager execution, things have changed.
author:
  - name: Sigrid Keydana
    affiliation: RStudio
...
The [eager execution guide](https://tensorflow.rstudio.com/articles/eager_guide.html) describes the workflow in detail.
...
See the [eager execution guide](https://tensorflow.rstudio.com/articles/eager_guide.html) for a complete example. Here, we want to answer the question: Why are we so excited about it? At least three things come to mind: 
...
When diving into these applications, it is a good idea to also refer to the [eager execution guide](https://tensorflow.rstudio.com/articles/eager_guide.html) so you don't lose sight of the forest for the trees.
