...
A complete workflow is demonstrated in the [eager execution guide](https://tensorflow.rstudio.com/articles/eager_guide.html). Here, we want to answer the question: Why are we so excited about it? At least three things come to mind: 
