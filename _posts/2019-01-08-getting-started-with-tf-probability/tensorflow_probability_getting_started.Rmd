...
If you already have TensorFlow and Keras installed, all that's required is a
...
```
Tensor("Normal_1/sample/Reshape:0", shape=(6,), dtype=float32)
```
...
```
tf.Tensor([-1.4189385 -0.9189385 -1.4189385], shape=(3,), dtype=float32)
```
...
```
tf.Tensor([1 1 1 0 1 1 0 1 0 1], shape=(10,), dtype=int32)
```
...
```
tf.Tensor([-1.2411538 -0.3411539 -1.2411538 -1.2411538], shape=(4,), dtype=float32)
```
