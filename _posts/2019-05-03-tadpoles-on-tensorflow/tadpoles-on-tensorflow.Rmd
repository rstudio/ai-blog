...
As with every TFP distribution, you can do a quick functionality check by sampling from the model:^[You might be wondering why we are not using eager execution, something we normally like to do.
