...
So as you might have guessed by now, _varying slopes_ (or _random slopes_, if you will) is the topiof today's post. Again, we take up an example from McElreath's book, and show how to accomplish the same thing with `tfprobability`.
