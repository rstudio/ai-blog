...
You can follow similar steps for RStudio and Kaggle boards, even for existing pins! Other boards like Amazon S3, Google Cloud, Digital Ocean and Microsoft Azure require you explicitly enable versioning when registering your boards.
...
To learn more about versioning visit the [Versioning Article](http://pins.rstudio.com/articles/advanced-versions.html), for DigitalOceaen use the [DigitalOcean Article](http://pins.rstudio.com/articles/boards-dospace.html). To catch up with previous releases:
