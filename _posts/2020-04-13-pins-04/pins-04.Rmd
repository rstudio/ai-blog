...
To learn more about versioning visit the [Versioning Article](http://pins.rstudio.com/articles/advanced-versions.html), for DigitalOcean use the [DigitalOcean Article](http://pins.rstudio.com/articles/boards-dospace.html). To catch up with previous releases:
