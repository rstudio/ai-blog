...
What would be even better than [sparklyr](https://sparklyr.ai) 1.2? Many brilliant minds from RStudio, Databricks, and the broader open-source community have contemplated this question for months. Now they have an answer -- [`sparklyr`](https://sparklyr.ai) 1.3 is now available on [CRAN](https://cran.r-project.org/web/packages/sparklyr/index.html), with the following major new features:
