...
description: |
  Sparklyr 1.3 is now available, featuring exciting new functionalities such as integration of Spark higher-order functions, data import/export in Avro and in user-defined serialization formats!
author:
  - name: Yitao Li
