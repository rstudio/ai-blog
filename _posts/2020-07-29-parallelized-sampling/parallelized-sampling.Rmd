...
In order to not deprive our dear readers the pleasure of completing this proof by themselves, I decided not to inline the rest of the proof within this blog post, and make everything available in [this file](proof.pdf) instead.
