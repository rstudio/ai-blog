...
For example, suppose we are given 5 rows, $r_1, r_2, \dotsc, r_5$ with weights $w_1, w_2, \dotsc, w_5$ where all weights are positive real numbers, and run `SWOR` to randomly select 3 rows, what is the probability of selecting $(r_1, r_2, r_3)$? 
...
In order to not deprive our dear readers the pleasure of completing this proof by themselves, I decided to not include any further detail here, and make everything available in [this file](proof.pdf) instead.
