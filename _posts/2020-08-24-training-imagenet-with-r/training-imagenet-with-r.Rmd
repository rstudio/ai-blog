...
description: >
  This post explores how to train large datasets with TensorFlow and R. Specifically, we present how to download and repartition ImageNet, followed by training them across multiple GPUs in distributed environments
author:
