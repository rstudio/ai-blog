...
If you've read some of our previous posts, you might be thinking of using -- the [pins](https://pins.rstudio.com) package! The pins package enables you to cache, discover and share resources from many services, including Kaggle. You can learn more about data retrieval from Kaggle in the [Using Kaggle Boards](http://pins.rstudio.com/articles/boards-kaggle.html) article; in the meantime, let's assume we are familiar with this package.
