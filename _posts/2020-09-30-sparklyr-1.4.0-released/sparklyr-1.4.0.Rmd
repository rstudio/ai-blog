...
- Plotting the result shows the non-outlier data points being scaled to values that still more or less form a bell-shaped distribution, as expected, so the scaling is robust against influences of the outliers:
