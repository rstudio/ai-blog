...
description: > 
 In this next-to-last installment of a mini-series introducing torch basics, we replace hand-coded matrix operations by modules, considerably simplifying our toy network's code. 
author:
  - name: Sigrid Keydana
    affiliation: RStudio
...
section into two parts, for clarity of exposition. In reality though,
