...
Model accuracy is `r scales::percent(val_acc, accuracy = 0.01)`, similar to the tensorflow version from the original post. Likewise, all conclusions from original post also hold.
