...
Our first goal was to find out in which settings, and for what kinds of applications, deep learning software is beingused.
...
Of those working with DL in industry, more than twenty said they worked in consulting, finance, and healthcare (each). IT, education, retail, pharma, and transportation were mentioned more than ten times (again, each):
...
In academia, dominant fields (as per survey participants) are bioinformatics, genomics, and IT, followed by biology, medicine, pharmacology, and social sciences:
...
What application areas matter to larger subgroups of "our" users? Nearly a hundred (of 138!) respondents said they used DL for some kind of image processing application (including classification, segmentation, and object detection). Next up was time series forecasting, followed, in third place, by unsupervised learning.

This is the point where I start mixing in questions and comments. The popularity of unsupervised DL comes a bit unexpected; had we anticipated this, we would have asked for more detail here. So if you're one of the people who selected this -- or if you didn't participate, but do use DL for unsupervised learning -- please let us know a bit more in the comments!

Next, NLP is about on par with the former; followed by DL on tabular data and anomaly detection. Bayesian deep learning, reinforcement learning, recommendation systems, and audio processing are still mentioned frequently.
...
An important thing for any software developer or content creator to investigate concerns proficiency / levels of expertise present in their audiences. It (nearly) goes without saying that expertise is very different from *self-reported* expertise. I'd like to be very cautious, then, to interpret the below results.
...
But of course (like I could end every single paragraph), sample size is moderate, and sample bias is present.
...
Finally, although this was mentioned just once, I'd like to relate a comment that went in a direction absent from all provided answer options, but that probably should have been there already: AI being used to construct social credit systems.
