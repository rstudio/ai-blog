...
description: > 
  It's been a while since this blog featured content about Keras for R, which may have given the impression that the project was dormant. It is high time to correct that impression.
  Keras for R is better than ever, with two recent releases adding powerful capabilities that considerably lighten previously tedious tasks.
