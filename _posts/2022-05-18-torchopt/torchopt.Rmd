...
To see how it looks, just scroll down a bit. The plot can be tweaked in a myriad of ways, but I'll stick with the default layout, with colors of shorter wavelength mapped to lower function values. 

Let's begin with our explorations.
