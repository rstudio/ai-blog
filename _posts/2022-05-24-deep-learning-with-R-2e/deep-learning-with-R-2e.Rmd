...
2nd Edition*](http://mng.bz/o2Yj). Compared to the first edition, the
book is over a third longer, with more than 75% new content. It's not so
much an updated edition as a whole new book.
...
Purchase the MEAP version of [Deep Learning with R, Second
Edition](http://mng.bz/o2Yj) using the launch discount code
**mlallaire2** for 40% off all formats. The code is valid through June
7.
