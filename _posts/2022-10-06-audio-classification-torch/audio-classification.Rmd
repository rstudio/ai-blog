...
description: >
  Learn how to classify speech utterances with torch, making use of domain knowledge and deep learning. This post is a condensed version of the same-topic chapter to be published with CRC Press, Deep Learning and Scientific Computing with R torch. 
author:
  - name: Sigrid Keydana
    affiliation: RStudio
