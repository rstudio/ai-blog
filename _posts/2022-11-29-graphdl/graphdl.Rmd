...
*Note: With RStudio having become [Posit](www.posit.co), and aiming to support both R and Python communities, we will have a mix of R and Python posts on this blog. To our dear R-loving readers: Please rest assured that, just like Posit will continue the work on R packages, you will continue to see R-related content on this blog.*
