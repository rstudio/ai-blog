...
Deep learning on graphs can be done in both frameworks currently dominating the market, TensorFlow as well as PyTorch. The most popular, at this time -- and fastest-growing in terms of functionality -- library is [PyTorch Geometric](https://pytorch-geometric.readthedocs.io/en/latest/#) (from hereon: PyG). In particular, this tendency is documented by more and more research groups switching to PyG -- and often, extending it in significant ways.

Of course, you can do deep learning on graphs in other libraries and frameworks. For researchers, though, to enable quick experimentation is of utmost importance; the same goes for extensive documentation and realistic use cases. For this and upcoming posts, thus, I have an immediate reason to choose PyG: I plan to write regularly about applications of deep learning in the sciences, and as far as GNNs are concerned, PyG is what an overwhelming amount of research papers uses.

As a regular reader, you may have stumbled across me writing: "PyTorch Geometric". What about R `torch`? Well, we'd love to have PyG in the `torch` ecosystem! But looking at the extent of this project, and, more importantly, its rapid, ever-accelerating growth, it would make sense for a `torchgeometric` to be a community effort. If you'd like to help, or if the upcoming posts make you feel like, please don't hesitate to let us know!

That said, let me come to what *this* post is for: get started with PyG for deep learning on graphs -- the low-level, "I want to _really_ understand" way.
