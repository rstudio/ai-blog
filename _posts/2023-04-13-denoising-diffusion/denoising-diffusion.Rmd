...
*As we're writing this -- it's April, 2020 -- it is hard to overstate
...
(known) noise rate schedule.

In conclusion, this post, by itself, is really just an invitation -- to
...
```{r, echo=FALSE, eval=TRUE, fig.alt = "A 6x8 arrangement of flower blossoms."}
