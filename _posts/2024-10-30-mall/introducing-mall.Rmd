...
Large Language Models (LLMs) were viable for daily use, sparking concerns among 
companies hesitant to share their data externally. Moreover, the cost of using 
LLMs is substantial, with per-token charges can add up quickly.
...
engineering, the possibilities seemed vast. To ensure the model was not too 
...
However, for Python, being a non-native language meant that I had to adapt my 
...
with Polar, which allowed me to extend the pandas API and create an llm namespace.
