...
We very much contributions to the TensorFlow for R blog from the broader R community. If you are interested in publishing some of your own work or insights, we'd love to hear from you! 

Articles posted on the TensorFlow for R blog are authored using [Radix for R Markdown](https://radixpub.github.io/radix-r). Here are the steps required to contribute a new article:
...
2. Create a new [Radix article](https://radixpub.github.io/radix-r) and check it into the GitHub repository (be sure to check in the the Rmd source code and the generated HTML files).
